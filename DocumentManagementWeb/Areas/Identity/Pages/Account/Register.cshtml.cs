...
namespace DocumentManagementWeb.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (Input.Role == SD.Role_Client || string.IsNullOrEmpty(Input.Role))
                    {
                        var contentRoot = _webHostEnvironment.ContentRootPath;
                        contentRoot += "\\UserFolders\\" + Input.Email;
